"""
Summary:
This is the __main__ file where all the other modules are called.
We set the environment, initialize the smartcab agent and then enable the GUI
...
def run():
    ...
    sim = Simulator(env,update_delay=2, log_metrics=True, display=True, optimized=True)
    ...
    sim.run(n_test=1, tolerance=0.05)
